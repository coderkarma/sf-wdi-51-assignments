...
// 	noise: "Meow",
// 	makeNoise: function () {
// 		console.log(`Cat is making ${this.noise}`)
// 	}
// }
...
// 	noise: "AWWWW!",
// 	makeNoise: function () {
// 		console.log(`bird is making ${this.noise}`)
// 	}
// }
...
// 	noise: "scratching",
// 	makeNoise: function () {
// 		console.log(`mouse is making ${this.noise} sound`)
// 	}
...
let animal = function (name, noise) {
	this.name = name;
	this.noise = noise;
	this.makeNoise = function () {
		console.log(`The ${this.name} is making ${this.noise}`);
	}
}
let bird = new animal("Parrot", "AWW!!")
let mouse = new animal("Mol", "!chee!")
let cat = new animal("Billy", "AWW!!")
let dog = new animal("Dog", "HOWll!!")
...
*/
let animals = [bird, mouse, cat, dog];
//  for (let i = 0; i < animals.length; i++){
	//aniamls[i].makeNoise()
//}
 animals.forEach(ele => ele.makeNoise())
...
*/
 ...
 animals.forEach(ele => ele["walk"] = `${this.ele} to a walk`)
//  console.log(animals)
...
console.log('dog make a new friend')
console.log(dog.makeFriend('cat'))
